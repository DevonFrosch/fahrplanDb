...
--
-- Host: localhost:3306
-- Erstellungszeit: 21. Aug 2021 um 21:39
...
CREATE TABLE IF NOT EXISTS `calendar` (
  `dataset_id` int(11) NOT NULL,
  `service_id` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  ...
  KEY `start_date` (`dataset_id`,`start_date`,`end_date`) USING BTREE,
  KEY `end_date` (`dataset_id`,`end_date`) USING BTREE
...
CREATE TABLE IF NOT EXISTS `calendar_dates` (
  ...
  KEY `date` (`dataset_id`,`date`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `routes` (
  ...
  KEY `agency` (`dataset_id`,`agency_id`) USING BTREE,
  KEY `route_type` (`dataset_id`,`route_type`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `stops` (
  ...
  KEY `stop_name` (`dataset_id`,`stop_name`) USING BTREE,
  KEY `stop_code` (`dataset_id`,`stop_code`) USING BTREE,
  KEY `location_type` (`dataset_id`,`location_type`) USING BTREE,
  KEY `parent_station` (`dataset_id`,`parent_station`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `stop_times` (
  ...
  KEY `stops` (`dataset_id`,`stop_id`) USING BTREE,
  KEY `stop_and_time` (`dataset_id`,`stop_id`,`departure_time`) USING BTREE,
  KEY `departure_time` (`dataset_id`,`departure_time`) USING BTREE,
  KEY `arrival_time` (`dataset_id`,`arrival_time`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `trips` (
  ...
  `trip_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `route_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `direction_id` enum('0','1') CHARACTE
/*!40101 SET CHARACTER_SET_CLIENT=@OLD_CHARACTER_SET_CLIENT */;
/*!40101 SET CHARACTER_SET_RESULTS=@OLD_CHARACTER_SET_RESULTS */;R SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `service_id` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  ...
  KEY `routes` (`dataset_id`,`route_id`) USING BTREE,
  KEY `service` (`dataset_id`,`service_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
