...
--
-- Host: localhost:3306
-- Erstellungszeit: 25. Mrz 2023 um 14:10
-- Server-Version: 10.3.38-MariaDB-0+deb10u1
-- PHP-Version: 7.3.33-10+0~20230214.103+debian10~1.gbp88ff76
...
CREATE TABLE `agency_import` (
  ...
  `agency_name` varchar(100) NOT NULL,
  `agency_timezone` varchar(20) DEFAULT NULL,
  `importExcluded` tinyint(1) NOT NULL DEFAULT 0,
  `importExclusion` varchar(100) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=COMPACT;
...
ALTER TABLE `agency_import`
  ADD PRIMARY KEY (`dataset_id`,`agency_id`) USING BTREE,
  ADD KEY `importExcluded` (`importExcluded`);
